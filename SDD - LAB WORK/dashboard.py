...
class Dashboard2:
    def __init__(self, window):
        self.window = window
        self.window.title("Personalised Dashboard for Student")
        ...
        # Name of User
        self.brandName = Label(self.sidebar, text='Zahid Hasan', bg='#ffffff', font=("", 15, "bold"))
        ...
        # Body Frame 2
        self.assignmentpen = Label(self.bodyFrame2, text='5', bg='#009aa5', font=("", 25, "bold"))
        self.assignmentpen.place(x=120, y=100)

        self.homeworkimage = ImageTk.PhotoImage(file='images/left-icon.png')
        self.homework = Label(self.bodyFrame2, image=self.homeworkimage, bg='#009aa5')
        self.homework.place(x=220, y=0)

        self.homework_label = Label(self.bodyFrame2, text="Homework", bg='#009aa5', font=("", 12, "bold"),
                                       fg='white')
        self.homework_label.place(x=5, y=5)

        # Body Frame 3
        self.assigmentpen = Label(self.bodyFrame3, text='2', bg='#e21f26', font=("", 25, "bold"))
        self.assignmentpen.place(x=120, y=100)

        # left icon
        self.assignmenticon = ImageTk.PhotoImage(file='images/left-icon.png')
        self.Left = Label(self.bodyFrame3, image=self.assignmenticon, bg='#e21f26')
        self.Left.place(x=220, y=0)

        self.assp_label = Label(self.bodyFrame3, text="Assignment Pending", bg='#e21f26', font=("", 12, "bold"),
                                      fg='white')
        self.assp_label.place(x=5, y=5)

        # Body Frame 4
        self.total_due = Label(self.bodyFrame4, text='Tk 40,000.00', bg='#ffcb1f', font=("", 25, "bold"))
        self.total_due.place(x=80, y=100)

        self.due_label = Label(self.bodyFrame4, text="Total Due", bg='#ffcb1f', font=("", 12, "bold"),
                                    fg='white')
        self.due_label.place(x=5, y=5)
        # Frame 4 icon
