...
class InfoEdu:
    def __init__(self, cf):
        self.eduInfo = Frame(cf, pady=10, padx=10)
        self.eduInfo.grid(row=0, column=0, sticky='senw')
        self.img = Image.open('university.png')
        self.img.thumbnail((200, 200))
        self.new_img = ImageTk.PhotoImage(self.img)
        self.imgedu = Label(self.universityInfo, image=self.new_img, padx=10, pady=10)
        self.imgedu.pack()
        self.buttonEdu = Button(self.universityInfo, command=self.openinfowindow, font=('tahoma', 10, 'bold'),
                                       text='About Institution', bg='#1b9ea4', fg='white', padx=10, pady=10)
...
class InfoWindow:
    def __init__(self):
        ...
        self.TitleLabel = Label(self.master, text='Faculty/Stream', bg='#1b9ea4', pady=100,
